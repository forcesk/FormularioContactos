...
public class DatosConfirmar_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datos_confirmar_);

        Button btnEditar = (Button) findViewById(R.id.btnEditarDatos);
        final Bundle parametros = getIntent().getExtras();
        datos = parametros.getStringArrayList(getResources().getString(R.string.pdata));
        ...
        btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DatosConfirmar_Activity.this, ContactoDatos_MainActivity.class);
